      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">
            Start buying bulk digital accounts today
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-gray-800 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-gray-600 bg-black/50 text-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
          ...
          <button
            type="button"
            className="w-full py-3 bg-white/5 border border-gray-700 text-white font-medium rounded-lg hover:bg-white/10 transition flex items-center justify-center gap-2"
          >
